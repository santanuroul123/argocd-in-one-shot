...
> For this, delete the kind cluster running and & ArgoCD setup, if you use existing setup - that can cause issue in sso setup in that guide. Follow that guide as it is.
